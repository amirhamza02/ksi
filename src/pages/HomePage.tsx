      ...
      <section className="gradient-bg text-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-12 max-w-4xl mx-auto leading-relaxed text-gray-600">
            Greetings and welcome to the admission portal of King Sejong
            Institute, IUB! To initiate the admission process, kindly create an
            account first. Then, you can log in using your Login ID (email) and
            password to access the admission portal.
          </p>

          <div className="space-y-4 md:space-y-0 md:space-x-6 md:flex md:justify-center">
            <Link
              to="/register"
              className="inline-block btn-primary btn-lg font-semibold shadow-md"
            >
              Apply Now
            </Link>
            <Link
              to="/login"
              className="inline-block btn-outline btn-lg font-semibold"
            >
              Login
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl font-bold text-primary mb-4">
              Available Korean Language Courses
            </h3>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive Korean language programs designed for
              all skill levels. Join thousands of students who have successfully
              learned Korean through our expert-led courses.
            </p>
          </div>
            ...
            {programs && programs?.length > 0
              ? programs
                  ...
                  .map((program) => (
                    <div
                      key={program.id}
                      className="bg-white border border-gray-100 rounded-lg p-6 hover:border-primary hover:shadow-lg transition-all duration-200 card-shadow"
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <span className="text-2xl font-bold text-primary">
                            ৳{program.regCost.toLocaleString()}
                          </span>
            ...
            <div className="mt-12 text-center">
              <div className="bg-gray-50 rounded-lg p-8">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Join our comprehensive Korean language programs and embark on
                  an exciting journey to master one of the world's most
                ...
                <div className="space-y-4 md:space-y-0 md:space-x-4 md:flex md:justify-center">
                  ...
                  <Link
                    to="/courses"
                    className="inline-block btn-outline btn-lg"
                  >
                    View All Courses
                  </Link>
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Register with your personal information to get started
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Choose from our available Korean language courses
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Pay the course fee and receive confirmation via email
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of students who have successfully learned Korean
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              Contact support at{" "}
              <a
                href="mailto:support@ksi.iub.edu.bd"
